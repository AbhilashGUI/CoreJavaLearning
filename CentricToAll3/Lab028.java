...
public class Lab028
{
   public static void main(String[] args)
   {
     ...
     name1="Vemula"; // Since we are replacing the name, it create a memory in SCP
     ...
     System.out.println(name2);
      ...
      System.out.println(new String("Vemula Abhilash Sharma")); //String is created in heap area because of using new operator
