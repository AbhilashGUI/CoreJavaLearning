...
public class Lab147
{
    public static void main(String [] args)
    {
        ...
        p7.name="Vicky";   //Since we are reassigning the name, new name reflects in the o/p along with the other attributes
        p7.printdetails();
        ...
        Person1 p2=new Person1("Abhilash Vemula");
        System.out.println(p2.name);
        Person1 p3=new Person1("vemulaabhilash8433@gmail.com");
