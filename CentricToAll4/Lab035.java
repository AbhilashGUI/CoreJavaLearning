...
public class Lab035 {
    public static void main(String[] args) {
        //Java provides statements which are used to control the flow of the java code. Such statements are known as control flow statements.
        //That helps to run the smooth flow of the program.
