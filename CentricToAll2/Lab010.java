...
public class Lab010
{
    public static void main(String[] args)
    {
        ...
        System.out.println("I'm eligible to caste my vote, since my age is :  " + age);
        ...
        //System.out.printf("I'm eligible to caste my vote, since my age is %d", age);

        int eligibleage=18;
        int myage=eligibleage+3;
        System.out.println(myage +"- Since I'm major I can have a license to drive a four wheeler");
    }
